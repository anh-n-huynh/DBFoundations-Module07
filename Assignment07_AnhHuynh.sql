...
-- 2022-2-28,AnhHuynh,Created File
-- 2022-3-1,AnhHuynh, Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AnhHuynh')
	 Begin 
	  Alter Database [Assignment07DB_AnhHuynh] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AnhHuynh;
	 End
	Create Database Assignment07DB_AnhHuynh;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AnhHuynh;
...
Select Top 10000000
Categories.CategoryName, Products.ProductName, Format (Products.UnitPrice, 'C', 'en-US') as UnitPrice
From dbo.Categories
...
-- <Put Your Code Here> --
Create Function dbo.fProductsbyInventoryCount()
Returns Table 
As
Return 
(Select Top 10000000
Products.ProductName, 
format (Inventories.InventoryDate, 'MMMM, yyyy') as InventoryDate, Inventories.Count
From dbo.Products
Join dbo.Inventories On Products.ProductID=Inventories.ProductID
Order by ProductName, Inventories.InventoryDate);
go 

select * from dbo.fProductsbyInventoryCount();
GO
...
format (Inventories.InventoryDate, 'MMMM, yyyy') as InventoryDate,
SUM (Count) as TotalInventoryCountbyCategory
From dbo.Categories
...
PreviousMonthCount = IIF(Month (InventoryDate) = 1, 0, lag (Count)
Over (Order By ProductName))
